...
def updateNodeIPs( env, nodes ):
    ...
    # TODO this looks like part of what is done to connect the cluster.
    ...
    # TODO in particular this line connects the clusters. Other lines may be important
    ...
    def configPortForwarding( self, ports=[], action='A' ):
        ...
        for port in ports:
            for index, node in enumerate( self.nodes() ):
                ...
                info('ONOS ports ' + str(ip) + ':' +  str(port) + ' -> ' + str(inport)+ ' ')
...
class ONOSCLI( OldCLI ):
    ...
    def do_tennison_status( self, line ):
        "Return status of TENNISON instances"
        info('2 instances of TENNISON are running \n')
