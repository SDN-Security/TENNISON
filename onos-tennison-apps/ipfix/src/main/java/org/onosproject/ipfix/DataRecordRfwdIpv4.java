 ...
 */
public class DataRecordRfwdIpv4 extends DataRecord implements AbstractIpRecordInterface {
   ...
   public int getDestinationPort() {
    ...
    public List<Data> getData() {
        ...
        dataList.add(new Data<IpAddress>("sourceIPv4Address", sourceIPv4Address));
        dataList.add(new Data<IpAddress>("destinationIPv4Address", destinationIPv4Address));
    ...
    public byte[] getBytes() throws HeaderException {
        try {
            ...
            System.arraycopy(Arrays.copyOfRange(Ints.toByteArray(sourceTransportPort),2,4), 0, data, 86, 2);
            System.arraycopy(Arrays.copyOfRange(Ints.toByteArray(destinationTransportPort),2,4), 0, data, 88, 2);
